		...
		<main className="flex-1 max-w-md w-full mx-auto p-8 flex flex-col items-center justify-center text-center min-h-[calc(100vh-65px)] gap-4">
			...
			<div className="flex gap-3 mt-2">
				<button
					...
					className="px-5 py-2.5 rounded-lg bg-blue-600 font-semibold text-foreground hover:bg-blue-500 transition-colors shadow-lg shadow-blue-500/10 text-sm cursor-pointer"
				>
					Try Again
				</button>
				<a
					href="/"
					className="px-5 py-2.5 rounded-lg bg-zinc-800 font-semibold text-foreground/90 hover:bg-zinc-700 transition-colors text-sm"
				>
					Return Home
				</a>
			</div>
