...
export default function ProjectDetailLoading() {
	return (
		<div className="w-full max-w-4xl mx-auto px-4 py-8 md:py-12 space-y-8 animate-pulse transition-colors duration-200">
			{/* Header Stack Simulator */}
			<div className="flex flex-col items-center space-y-4 text-center">
				{/* Project Title Placeholder */}
				<div className="h-10 w-3/4 md:w-1/2 bg-muted rounded-xl" />
			...
			<div className="w-full aspect-video rounded-2xl border border-border bg-card/40" />
